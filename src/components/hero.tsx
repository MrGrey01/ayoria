...
const y = useTransform(
  ...
  return (
    ...
    >
      {/* background glow */}
      <div className="absolute left-1/2 top-0 h-125 w-125 -translate-x-1/2 rounded-full bg-yellow-500/10 blur-[150px]" />
      ...
      <div className="container relative mx-auto px-6">
        <div className="grid min-h-[85vh] items-center gap-16 lg:grid-cols-2">
          ...
          >
            <span className="mb-6 inline-block rounded-full border border-yellow-500/20 bg-yellow-500/10 px-5 py-2 text-sm uppercase tracking-[0.25em] text-brand-gold">
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              <BookingModal
                size="lg"
                className="bg-yellow-500 text-black hover:bg-brand-gold"
              />

              <Button
                size="lg"
                variant="outline"
                className="border-yellow-500 text-brand-gold hover:bg-yellow-500 hover:text-black"
              >
                View Gallery
...
<motion.div style={{ y }}>
            ...
            <div className="absolute bottom-10 left-1/2 w-[280px] -translate-x-1/2 rounded-3xl border border-yellow-500/20 bg-black/80 p-6 backdrop-blur-xl">
